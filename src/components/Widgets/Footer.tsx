      ...
      <div className="max-w-300 m-auto px-5 lg:px-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative mt-1 max-w-60">
            ...
            <button
              type="button"
              className="absolute right-3 top-1/2 -translate-y-1/2 text-white hover:text-red-400 transition cursor-pointer"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-5">
            <span className="w-8 h-8 rounded-full bg-[#1F1F1F] flex items-center justify-center hover:bg-[#DB4444] transition cursor-pointer text-white">
